...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 14, 2025 at 05:23 PM
...
(1, 'אבקת חלבון WHEY בטעם שוקולד לבן', 'אבקות חלבון', 'לחובבי השוקולד הלבן! אבקת חלבון WHEY בטעם שוקולד לבן מספקת 26 גרם חלבון איכותי ו-5.8 גרם BCAA בכל מנה, עם מרקם קרמי וטעם עשיר שמתמזג מושלם עם שייקים ותוספות. אידיאלי להתאוששות מהירה לאחר אימון או להוספת מתיקות עדינה לשייק היומי שלך!', 299.00, '1749756736271.webp', 14, 1),
...
(3, 'אבקת חלבון WHEY בטעם פיסטוק', 'אבקות חלבון', 'אבקת חלבון WHEY בטעם פיסטוק אריזה גדולה', 299.00, '1749760087096.webp', 14, 1),
...
('242422', 'Ariam Rahal', '0503982224', 'Ariam.rahal@gmail.com', '$2b$10$jWkPLoQxCM60HTDy7Er3k.Xz8C0I0HJ7gVMPQOmeO.yZPu8gWXbma', 'Trainee');
...
--
ALTER TABLE `exercises`
  MODIFY `ExerciseID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
