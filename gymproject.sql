...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 04, 2025 at 08:08 PM
...
INSERT INTO `exercises` (`ExerciseID`, `Type`, `Date`, `StartTime`, `EndTime`, `CoachID`, `AllowedMembership`) VALUES
(26, 'כוח', '2025-06-11', '12:00:00', '13:00:00', '213417292', 'Group'),
(27, 'כוח', '2025-06-26', '12:00:00', '13:00:00', '213417292', 'Group'),
(29, 'כוח', '2025-06-18', '12:00:00', '13:00:00', '213417292', 'Single'),
(30, 'רגליים', '2025-06-28', '12:00:00', '13:00:00', '213417292', 'Group'),
(31, 'רגליים', '2025-06-28', '13:00:00', '14:00:00', '21345689', 'Single'),
(32, 'רגליים', '2025-08-08', '10:00:00', '11:00:00', '213417292', 'Group'),
(35, 'רגליים', '2025-07-08', '12:00:00', '15:00:00', '213417292', 'Couple'),
(38, 'כוח', '2025-08-10', '08:00:00', '09:00:00', '213417292', 'Couple'),
(39, 'רגליים', '2025-08-01', '11:00:00', '12:00:00', '213417292', 'Group'),
(41, 'ליבה', '2025-08-02', '10:00:00', '11:00:00', '2134334332', 'Group'),
(42, 'חלק עליון', '2025-08-03', '07:00:00', '08:00:00', '2134334332', 'Couple'),
(43, 'חלק עליון', '2025-08-03', '11:00:00', '12:00:00', '2134334332', 'Group'),
(44, 'חלק עליון', '2025-08-03', '16:00:00', '17:00:00', '2134334332', 'Single'),
(45, 'כל הגוף', '2025-08-01', '09:00:00', '10:00:00', '21345689', 'Group');
...
(3, '242422', '2025-07-25', 'Accepted', 270.00),
...
(8, '213417292', '2025-08-04', 'Pending', 306.54);
...
(1, 'מארז 18 חטיפי חלבון EXTRA SOFT בטעם קרם עוגיות', 'אבקות חלבון', 'חטיף חלבון רך במיוחד עם מרקם מפנק, מצופה בשוקולד עשיר ובעל שכבת קרם בטעם קרם עוגיות. מכיל 15 גרם חלבון, 2.5 גרם BCAA, ורק 2.2 גרם סוכר – אידיאלי לשמירה על תזונה מאוזנת, חיטוב ובניית שריר. החטיף המושלם לאחר אימון, בין ארוחות או כשמתחשק משהו מתוק ומזין!', 199.00, '1749756736271.webp', 6, 1, 1),
(2, 'אבקת חלבון WHEY בטעם וניל', 'אבקות חלבון', 'הקלאסיקה האולטימטיבית! אבקת חלבון WHEY בטעם וניל מציעה 25 גרם חלבון איכותי ו-5.7 גרם BCAA בכל מנה, עם מרקם חלק וטעם וניל עשיר. מושלם להתאוששות לאחר אימון או כשמתחשק לכם שייק חלבון קרמי ומפנק!', 299.00, '1749756036586.webp', 32, 1, 0),
(5, 'מארז 18 חטיפי חלבון EXTRA SOFT בטעם קרם עוגיות', 'חטיפי חלבון', 'חטיף חלבון רך במיוחד עם מרקם מפנק, מצופה בשוקולד עשיר ובעל שכבת קרם בטעם קרם עוגיות. מכיל 15 גרם חלבון, 2.5 גרם BCAA, ורק 2.2 גרם סוכר – אידיאלי לשמירה על תזונה מאוזנת, חיטוב ובניית שריר. החטיף המושלם לאחר אימון, בין ארוחות או כשמתחשק משהו מתוק ומזין!', 270.00, '1749763653573.webp', 12, 3, 1),
...
(19, 'מארז משקה אנרגיה ALLIN INERGY בטעם טרופי – 24 יחידות', 'אולאין אינרג\'י', 'ALLIN INERGY – משקה פונקציונלי מוגז עם קפאין ממקור טבעי, חומצות אמינו מסועפות (BCAA) וויטמינים. ללא סוכר – אידיאלי לרענון והתחדשות במהלך היום או לפני אימון!', 262.00, '1751130872617.webp', 11, 4, 0);
...
(8, '0987654333', '2025-08-04', '2026-08-04', 'Yearly', 4914.00, 'Couple', 'Ayan Rahal');
...
--
ALTER TABLE `exercises`
  MODIFY `ExerciseID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
