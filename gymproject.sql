...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 08, 2025 at 06:03 PM
...
(9, '242422', '2025-08-06', 'Pending', 631.80);
...
(1, 'מארז 18 חטיפי חלבון EXTRA SOFT בטעם קרם עוגיות', 'אבקות חלבון', 'חטיף חלבון רך במיוחד עם מרקם מפנק, מצופה בשוקולד עשיר ובעל שכבת קרם בטעם קרם עוגיות. מכיל 15 גרם חלבון, 2.5 גרם BCAA, ורק 2.2 גרם סוכר – אידיאלי לשמירה על תזונה מאוזנת, חיטוב ובניית שריר. החטיף המושלם לאחר אימון, בין ארוחות או כשמתחשק משהו מתוק ומזין!', 199.00, '1749756736271.webp', 3, 1),
(2, 'אבקת חלבון WHEY בטעם וניל', 'אבקות חלבון', 'הקלאסיקה האולטימטיבית! אבקת חלבון WHEY בטעם וניל מציעה 25 גרם חלבון איכותי ו-5.7 גרם BCAA בכל מנה, עם מרקם חלק וטעם וניל עשיר. מושלם להתאוששות לאחר אימון או כשמתחשק לכם שייק חלבון קרמי ומפנק!', 299.00, '1749756036586.webp', 32, 1),
(5, 'מארז 18 חטיפי חלבון EXTRA SOFT בטעם קרם עוגיות', 'חטיפי חלבון', 'חטיף חלבון רך במיוחד עם מרקם מפנק, מצופה בשוקולד עשיר ובעל שכבת קרם בטעם קרם עוגיות. מכיל 15 גרם חלבון, 2.5 גרם BCAA, ורק 2.2 גרם סוכר – אידיאלי לשמירה על תזונה מאוזנת, חיטוב ובניית שריר. החטיף המושלם לאחר אימון, בין ארוחות או כשמתחשק משהו מתוק ומזין!', 270.00, '1749763653573.webp', 12, 3),
...
(10, '347217394', '2025-08-08', '2025-09-08', 'Monthly', 292.50, 'Group', 'sama jaber'),
...
--
ALTER TABLE `exercises`
  MODIFY `ExerciseID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=127;
...
--
ALTER TABLE `subscription`
  MODIFY `SubscriptionID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
