...
const loginAttempts = {}; // { email: { count: x, lastAttempt: timestamp } }
const verificationCodes = {}; // { email: { code: "123456", createdAt: timestamp } }
...
router.post("/send-code", async (req, res) => {
  ...
  try {
    ...
    // حفظ الكود مؤقتاً في الذاكرة مع وقت الإنشاء
    ...
    const transporter = nodemailer.createTransport({
      service: "gmail",
      auth: {
        user: "arwad.rahal1@gmail.com",       // ✨ ضع بريدك هنا
        pass: "oqal ssqj krgp bkgk"           // ✨ ضع كلمة مرور التطبيق
      }
    });
    ...
    res.json({ success: true, message: "הקוד נשלח למייל", code : code });
  } catch (err) {
