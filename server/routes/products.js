...
// מגדיר איפה וכיצד יש לשמור קבצים שהועלו
...
const upload = multer({ storage: storage }); // אתחול middleware להעלאת קבצים

// מחזיר את כל המוצרים מהדאטהבייס
...
// יוצר מוצר חדש ושומר את התמונה שהועלתה
...
// מוחק מוצר לפי קוד ומסיר את קובץ התמונה שלו
...
// מעדכן פרטי מוצר וקובץ תמונה חדש במידה והועלה
