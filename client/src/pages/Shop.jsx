...
export default function Shop() {
  ...
  // בוקפ לאישור תשלום עגלה
  function CartPayPopup({ open, onClose, total, onConfirm, loading, error }) {
    ...
    return !open ? null : (
      <div style={{
        ...
        <div style={{
          ...
          <h2 style={{ color: "#a68cf1", marginBottom: 8 }}>לתשלום: <span style={{color:'#222'}}>{total.toFixed(2)} ₪</span></h2>
          <input placeholder="שם על הכרטיס" value={name} onChange={e=>setName(e.target.value)} style={inputStyle} />
          <input
